...
(*  ###  framerate  ###  *)
fun frame_begin () : ulint = "sta#frame_begin"
...
fun sphere_merge_many {n,m:nat | m == n - 1} ( s: &(@[sphere][n]), count: int m ) : sphere = "sta#%"
...
fun sphere_intersects_frustum ( s: sphere, f: &frustum ) : bool = "sta#%"
