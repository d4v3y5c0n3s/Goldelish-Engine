...
fn fpath_full (path_in: !fpath) : fpath
fn fpath_file (path: !fpath) : fpath
fn fpath_file_location (path: !fpath) : fpath
fn fpath_file_extension (path: !fpath) : fpath
...
fn timestamp (out: string, ts_counter: int) : int

(*  ###  framerate  ###  *)
fn frame_begin () : ulint
fn frame_end ( fstartt: ulint, fendt: ulint, ftimev: ulint, facct: ulint, fcntr: ulint, frv: ulint ) : (ulint, ulint, ulint, ulint, ulint, ulint)
fn frame_end_at_rate ( fps: double, fstartt: ulint, fendt: ulint, ftimev: ulint, facct: ulint, fcntr: ulint, frv: ulint ) : void
