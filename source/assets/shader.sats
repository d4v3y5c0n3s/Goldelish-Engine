...
fun shader_program_set_int ( p: shader_program ptr, name: string, val: int ) : void = "sta#%"
fun shader_program_set_float ( p: shader_program ptr, name: string, val: float ) : void = "sta#%"
fun shader_program_set_vec2 ( p: shader_program ptr, name: string, val: vec2 ) : void = "sta#%"
fun shader_program_set_vec3 ( p: shader_program ptr, name: string, val: vec3 ) : void = "sta#%"
fun shader_program_set_vec4 ( p: shader_program ptr, name: string, val: vec4 ) : void = "sta#%"
fun shader_program_set_mat3 ( p: shader_program ptr, name: string, val: mat3 ) : void = "sta#%"
fun shader_program_set_mat4 ( p: shader_program ptr, name: string, val: mat4 ) : void = "sta#%"
fun shader_program_set_float_array ( p: shader_program ptr, name: string, vals: float ptr, count: int ) : void = "sta#%"
fun shader_program_set_vec2_array ( p: shader_program ptr, name: string, vals: vec2 ptr, count: int ) : void = "sta#%"
fun shader_program_set_vec3_array ( p: shader_program ptr, name: string, vals: vec3 ptr, count: int ) : void = "sta#%"
fun shader_program_set_vec4_array ( p: shader_program ptr, name: string, vals: vec4 ptr, count: int ) : void = "sta#%"
fun shader_program_set_mat4_array ( p: shader_program ptr, name: string, vals: mat4 ptr, count: int ) : void = "sta#%"
