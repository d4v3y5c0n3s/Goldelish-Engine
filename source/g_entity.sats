...
#define entity_get_as(fmt, type, ...) ((type ptr)entity_get_as_type_id(fmt, typeid(type)), ##__VA_ARGS__)
*)

fun entity_exists ( fmt: string, () ) : bool = "sta#%"
fun entity_get ( fmt: string, () ) : ptr = "sta#%"
fun entity_get_as_type_id ( fmt: string, type_id: int, () ) : ptr = "sta#%"
fun entity_new_type_id ( fmt: string, type_id: int, () ) : ptr = "sta#%"
fun entity_delete ( fmt: string, () ) : void = "sta#%"

fun entity_name ( e: ptr ) : string = "sta#%"
fun entity_typename ( a: ptr ) : string = "sta#%"
...
#define entities_get(out, returned, type) entities_get_type_id((entity ptr ptr)out, returned, typeid(type)) 
*)

fun entity_new_type_id ( name_format: string, count: int, type_id: int ) : void = "sta#%"
fun entity_get_type_id ( out: ptr, returned: ptr, type_id: int ) : void = "sta#%"