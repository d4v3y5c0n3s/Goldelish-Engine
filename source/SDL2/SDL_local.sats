...
fun SDL_PathFullName {l:addr} ( dstpf: string @ l | dst: ptr l, path: string ) : void = "mac#%"
fun SDL_PathFileName {l:addr} (dstpf: string @ l | dst: ptr l, path: string ) : void = "mac#%"
fun SDL_PathFileExtension {l:addr} (dstpf: string @ l | dst: ptr l, path: string ) : void = "mac#%"
fun SDL_PathFileLocation {l:addr} (dstpf: string @ l | dst: ptr l, path: string ) : void = "mac#%"
fun SDL_PathRelative {l:addr} (dstpf: string @ l | dst: ptr l, path: string ) : void = "mac#%"
fun SDL_PathForwardSlashes ( path: string ) : void = "mac#%"
fun SDL_PathJoin {l:addr} (dstpf: string @ l | dst: ptr l, fst: string, snd: string ) : void = "mac#%"
fun SDL_PathIsFile ( path: string ) : bool = "mac#%"
fun SDL_PathIsDirectory ( path: string ) : bool = "mac#%"
fun SDL_PathParentDirectory {l:addr} (dstpf: string @ l | dst: ptr l, path: string ) : void = "mac#%"
